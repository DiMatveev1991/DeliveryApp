...
namespace Delivery.DTOs
{
    public class OrderDto
    {
        ...
        //TODO на подумать
        public string FullFromAddress => FromAddress?.City + " " + FromAddress?.Street + " " + FromAddress?.HomeNumber +" " + FromAddress?.ApartmentNumber;
        public string FullTargetAddress => TargetAddress?.City + " " + TargetAddress?.Street + TargetAddress?.HomeNumber + " " + TargetAddress?.ApartmentNumber;
