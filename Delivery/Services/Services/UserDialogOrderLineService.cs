...
namespace Delivery.WPF.Services.Services
{
    internal class UserDialogOrderLineService : IUserDialogOrderLine
    {
        ...
        {
            var orderLineEditorViewModel = new OrderLineEditorViewModel(orderEditorViewModel.SelectedOrderLine, this);
            ...
            return _orderLineEditorWindow.ShowDialog() != true && orderLineEditorViewModel.WasChanged;
