...
namespace DbInitialize
{
    public class DbInitializer
    {
        ...
        {
			orderStatuses[0] = new OrderStatus() { StatusName = OrderStatusesConst.NewOrder};
            orderStatuses[1] = new OrderStatus() { StatusName = OrderStatusesConst.OrderSubmittedForExecution };
            orderStatuses[2] = new OrderStatus() { StatusName = OrderStatusesConst.CompletedOrder };
            orderStatuses[3] = new OrderStatus() { StatusName = OrderStatusesConst.ChanelOrder };
        ...
        {
            courierStatuses[0] = new CourierStatus() { StatusName = CourierStatusesConstant.OnJobStatus };
            courierStatuses[1] = new CourierStatus() { StatusName = CourierStatusesConstant.ReadyToJobStatus };
